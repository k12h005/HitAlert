...
class _MQ4PageState extends State<MQ4Page> {
  ...
  void getData() async {
    ...
    http.Response response = await http
        .get(Uri.parse("https://hitalert.000webhostapp.com/API/MQ4_feach.php"));
                  ...
                  Padding(padding: EdgeInsets.only(left: 16,right: 16,top: 24,bottom: 8),
                    child: Row(
                      children: [
                        ...
                        Text(jsonDecode(data!)['MQ4'][index]['READING_TIME'],
                  ...
                  Padding(padding: EdgeInsets.only(left: 16,right: 16,top: 8,bottom: 24),
                    child: Row(
                      children: [
                        ...
                        Text(jsonDecode(data!)['MQ4'][index]['MQ4_VALUE'],
                            style: TextStyle(color: Colors.white,fontWeight: FontWeight.normal))
                      ],
                    ),
                  ),
