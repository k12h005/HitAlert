...
class _SmokePageState extends State<SmokePage> {
  ...
  void getData() async {
    ...
    http.Response response = await http.get(
        Uri.parse("https://hitalert.000webhostapp.com/API/smoke_fetch.php"));
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        isLoading = false;
        all_data = jsonDecode(data!)['smoke'];
      });
    }
  }
                  ...
                  Padding(padding: EdgeInsets.only(left: 16,right: 16,top: 24,bottom: 8),
                    child: Row(
                      children: [
                        ...
                        Text(jsonDecode(data!)['smoke'][index]['READING_TIME'],
                  ...
                  Padding(padding: EdgeInsets.only(left: 16,right: 16,top: 8,bottom: 24),
                    child: Row(
                      children: [
                        ...
                        Text(jsonDecode(data!)['smoke'][index]['SMOKE_VALUE'],
                            style: TextStyle(color: Colors.white,fontWeight: FontWeight.normal))
                      ],
                    ),
                  ),
